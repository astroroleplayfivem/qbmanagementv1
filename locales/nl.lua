...
local Translations = {
    ...
    body = {
        ...
        ['depositm'] = 'Geld storten <br> Beschikbare balans: â‚¬',
        ['withdrawm'] = 'Geld opnemen <br> Available balans: â‚¬',
        ['submit'] = 'Bevestigen',
        ['amount'] = 'Hoeveelheid',
        ['return'] = 'Terug',
        ['exit'] = 'Afsluiten',
    ...
    bodygang = {
        ...
        ['depositm'] = 'Stort Geld <br> Beschikbare Balans: â‚¬',
        ['withdrawm'] = 'Neem Geld Op <br> Beschikbare Balans: â‚¬',
        ['submit'] = 'Bevestig',
        ['amount'] = 'Bedrag',
        ['return'] = 'Terug',
        ['exit'] = 'Afsluiten',
